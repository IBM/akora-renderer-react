...
A react renderer for use with IBM CloudPak for Watson AIOps Akora UI extensions. This renderer
can be used to render a given React component with some provided props, via a mapper.
